...
def test_create_saves_provided_reading_for_device(client):
    pass

def test_create_saves_multiple_readings_for_device(client):
    pass

def test_create_appends_new_readings_for_device(client):
    pass

def test_create_for_new_device_does_not_impact_unrelated_device(client):
    pass

def test_create_ignores_duplicate_timestamp_reading(client):
    pass

def test_create_returns_error_if_device_id_missing(client):
    pass

def test_create_returns_error_if_readings_missing(client):
    pass

def test_create_returns_error_if_device_id_invalid(client):
    pass

def test_create_returns_error_if_reading_count_not_present(client):
    pass

def test_create_returns_error_if_reading_count_not_integer(client):
    pass

def test_create_returns_error_if_reading_count_not_positive(client):
    pass

def test_create_returns_error_if_reading_timestamp_not_present(client):
    pass

def test_create_returns_error_if_reading_timestamp_not_string(client):
    pass

def test_create_returns_error_if_reading_timestamp_not_valid(client):
    pass

def test_create_returns_error_if_one_reading_entry_invalid_but_others_valid(client):
    # And validate no data saved for device
    pass
